...
SUPPORT_GRP = getenv("SUPPORT_GRP", "https://t.me/+bVfr7F--aIg5Zjk9")
UPDATE_CHNL = getenv("UPDATE_CHNL", "https://t.me/+qxrKjbv-Ab8yOTI1")
OWNER_USERNAME = getenv("OWNER_USERNAME", "saniya_queen_ff")
